...
import (
	...
	"github.com/michaeljsaenz/healthcheck-operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(checkv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "e2fb85ea.x-health.io",
